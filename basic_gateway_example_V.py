...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--serial', type=str, default='COM32', dest='sport', required=False, help='serial port')
    parser.add_argument('-b', '--baud', type=int, default=19200, dest='brate', required=False, help='baud rate')
    r = parser.parse_args()
